...
public enum ResponseType {
    CONNECTION_OK("Player well connected"), CONNECTION_KO("Player not connected"), PLAYER_SEATED("Player seat on table"), GAME_CAN_RUN(
            "All player here, game begin"), DISTRIBUTION("Game distributed"), NEW_CARDS("The 3 cards swap with others players"),CHANGE_CARD_MODE("Players have to change cards"), FOLD_PLAYED(
