...
public enum ResponseType {
    CONNECTION_OK("Player well connected"), CONNECTION_KO("Player not connected"), PLAYER_DISCONNECTED("A player disconnected, game pause"), PLAYER_SEATED(
            ...
            "Player make an annonce"), EMPTY("Use for test"), CHAT("Chat message"), WHERE_GIVE_FOLD("Where player want to give card"),GIVE_FOLD_DRAGON("Give fold to another player when dragon is played"), CAPOT(
